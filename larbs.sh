#!/bin/sh
# Sife's Auto Rice Boostrapping Script (SARBS)
# by Luke Smith <luke@lukesmith.xyz>
# and Sife <github.com/Sife-ops>
# License: GNU GPLv3
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/Sife-ops/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/Sife-ops/LARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Sife's Auto-Rice
